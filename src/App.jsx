...
export default function App() {
    ...
    useEffect(() => {
        // Passo 1: Carregar dados iniciais síncronos para evitar tela em branco.
        const dadosIniciais = psicologasData.map(psi => ({
            ...psi,
            horarios_disponiveis: {} // Horários começam vazios
        }));
        const shuffledIniciais = [...dadosIniciais].sort(() => 0.5 - Math.random());
        setPsicologasList(shuffledIniciais);

        // Passo 2: Buscar os horários da API em segundo plano.
        const fetchHorarios = async () => {
            ...
            try {
                ...
                // Passo 3: Atualizar a lista de psicólogas com os horários recebidos.
